...
public final class SubCommandInjector<C> extends AnnotationDataInjector<Command<C>, C, SubCommand> {
	
	public SubCommandInjector(Imperat<C> dispatcher) {
		super(
						dispatcher,
						InjectionContext.of(SubCommand.class, new TypeWrap<Command<C>>() {}, AnnotationLevel.METHOD)
		);
	}
	...
	public @NotNull <T> Command<C> inject(
		...
		*/
		var usage = CommandUsage.<C>builder()
