...
public final class SmartUsageResolve<C> {
	...
	public void resolve(CommandDispatcher<C> dispatcher, ResolvedContext<C> context) throws CommandException {
	...
	private <T> T getResult(ValueResolver<C, T> resolver, Context<C> context, String raw, CommandParameter currentParameter) throws CommandException {
		return resolver.resolve(context.getCommandSource(), context, raw, pivot, currentParameter);
	}
